...
class MMedicineListPage extends StatefulWidget {
...
class _MedicineListPage extends State<MMedicineListPage> {
  TextEditingController searchController = TextEditingController();

  @override
  void initState() {
    super.initState();
    MMedicineListPage.categories.clear();
    fetchData();
    ...
    if (res.statusCode == 200) {
      ...
      if (response['error'] == false) {
        for (int i = 0; i < response['data'].length; i++) {
          ...
          MMedicineListPage.categories.add(Category(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search about the medicin or category...',
          ...
          Expanded(
            child: ListView(
              children: MMedicineListPage.categories.map((category) {
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  reverse: false, // Display cards from right to left
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  'The scientific name: ${medicine.scientificName}',
                                  textDirection: TextDirection.ltr),
                              Divider(),
                              Text('Trade Name: ${medicine.commercialName}',
                                  textDirection: TextDirection.ltr),
                              Divider(),
                              Text(
                                  'the manufacture company: ${medicine.manufacturer}',
                                  textDirection: TextDirection.ltr),
                              Divider(),
                              Text(
                                  'the quantity available: ${medicine.quantity}',
                                  textDirection: TextDirection.ltr),
                              Divider(),
                              Text(
                                  'Expiration date: ${medicine.expirationDate}',
                                  textDirection: TextDirection.ltr),
                              Divider(),
                              Text('Price: ${medicine.price} L.S',
                                  textDirection: TextDirection.ltr),
                            ],
                          ),
                        ),
