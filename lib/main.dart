...
import 'package:store/ARABIC/register.dart';
import 'package:store/ENGLESH/logine -E.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Future<void> _precacheImage(BuildContext context) async {
    await precacheImage(AssetImage('images/download.png'), context);
  }
          ...
          child: Row(
            ...
            children: [
              ...
              Column(children: [
                ClipOval(
                  child: Image.network(
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqKVcB2QmgdmhJ4PIx-QqRe3f2igS3A1AhgQ&usqp=CAU",
                    loadingBuilder: (BuildContext context, Widget child,
                        ImageChunkEvent? loadingProgress) {
                      if (loadingProgress == null) {
                        return child;
                ...
                ClipOval(
                  child: FutureBuilder(
                    future: _precacheImage(
                        context), // استخدام Future لانتظار تحميل الصورة
