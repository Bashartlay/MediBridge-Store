...
class AddMedicinePage extends StatefulWidget {
  ...
  @override
  _AddMedicinePage createState() => _AddMedicinePage();
}
...
class _AddMedicinePage extends State<AddMedicinePage> {
  ...
  void initState() {
    super.initState();
    AddMedicinePage.pharmacistAccounts = [];
    fetchData();
  }
    ...
    if (res.statusCode == 200) {
      ...
      if (response['error'] == false) {
        for (int i = 0; i < response['data'].length; i++) {
          ...
          AddMedicinePage.pharmacistAccounts.add(PharmacistAccount(
          ...
          children: [
            ...
            Stack(
              children: [
                ...
                if (AddMedicinePage.pharmacistAccounts.length > 0)
                  Positioned(
                    right: 5,
                    top: 5,
                    child: Container(
                      ...
                      child: Text(
                        AddMedicinePage.pharmacistAccounts.length.toString(),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 12,
                        ),
  ...
  void _add(context) async {
    ...
    if (res.statusCode == 200 || res.statusCode == 201) {
      ...
      if (res.statusCode == 422) {
        _showMessage(context, 'تأكد من إدخال معلوماتك بشكل صحيح');
      } else {
        print(res.body);
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: AddMedicinePage.pharmacistAccounts.map((account) {
              return ListTile(
